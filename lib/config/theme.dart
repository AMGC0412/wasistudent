...
class WasiColors {
  ...
  static const Color primaryContainer = Color(0xFFFBEDEB);
  static const Color onPrimaryContainer = Color(0xFF4A1611);
  ...
  static const Color secondaryContainer = Color(0xFFF4E5BC);
  static const Color onSecondaryContainer = Color(0xFF8B6914);

  // ── Éxito: Verde andino ──
  static const Color success = Color(0xFF2D6A4F);
  static const Color successLight = Color(0xFF52B788);
  static const Color successDark = Color(0xFF235540);
  static const Color successContainer = Color(0xFFE8F3EE);
  static const Color onSuccessContainer = Color(0xFF1A3D2C);

  // ── Error: Rojo profundo ──
  static const Color error = Color(0xFFBC1A1A);
  static const Color errorLight = Color(0xFFE04545);
  static const Color errorDark = Color(0xFF7A0F0F);
  static const Color errorContainer = Color(0xFFFDE0E0);
  static const Color onErrorContainer = Color(0xFF7A0F0F);

  // ── Superficie claro (crema cálida, no blanco frío) ──
  static const Color backgroundLight = Color(0xFFFBF7F0);
  static const Color surfaceLight = Color(0xFFFFFFFF);
  static const Color surfaceVariantLight = Color(0xFFFAF4E9);
  static const Color outlineLight = Color(0xFFE0D5C0);
  static const Color outlineVariantLight = Color(0xFFECE3D2);

  // ── Superficie oscuro ──
  static const Color backgroundDark = Color(0xFF15110C);
  static const Color surfaceDark = Color(0xFF1F1A14);
  static const Color surfaceVariantDark = Color(0xFF2A231A);
  static const Color outlineDark = Color(0xFF3E342A);
  static const Color outlineVariantDark = Color(0xFF2A231A);

  // ── Texto ──
  static const Color textPrimaryLight = Color(0xFF2D2418);
  static const Color textSecondaryLight = Color(0xFF6B5D4F);
  static const Color textTertiaryLight = Color(0xFFA0927F);
  static const Color textPrimaryDark = Color(0xFFFBF7F0);
  static const Color textSecondaryDark = Color(0xFFD5C8B5);
  static const Color textTertiaryDark = Color(0xFFA0927F);

  // ── Info: Azul profundo ──
  static const Color info = Color(0xFF264653);
  static const Color infoLight = Color(0xFF2A9D8F);
  static const Color infoContainer = Color(0xFFE7F0F2);

  // ── Warning: Coral suave ──
  static const Color warning = Color(0xFFE76F51);
  static const Color warningContainer = Color(0xFFFCE4DD);
