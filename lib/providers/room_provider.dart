...
class RoomProvider extends ChangeNotifier {
  ...
  void _applyFilters() {
    ...
    switch (_sortBy) {
      ...
      case 'newest':
      default:
        rooms.sort((a, b) => (b.createdAt ?? DateTime.now()).compareTo(a.createdAt ?? DateTime.now()));
        break;
    }
  ...
  List<Room> getVerifiedRooms() {
    ...
    verified.sort((a, b) => (b.createdAt ?? DateTime.now()).compareTo(a.createdAt ?? DateTime.now()));
